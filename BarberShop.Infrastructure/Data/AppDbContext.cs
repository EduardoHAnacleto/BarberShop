...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.Property(e => e.Name).HasColumnName("CustomerName");
            entity.Property(e => e.DateOfBirth).HasColumnName("CustomerDateOfBirth");
            entity.Property(e => e.Email).HasColumnName("CustomerEmail");
            entity.Property(e => e.PhoneNumber).HasColumnName("CustomerPhoneNumber");
        });
