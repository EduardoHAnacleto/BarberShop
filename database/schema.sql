...
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[Services]') AND type = 'U')
BEGIN
...
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[Customers]') AND type = 'U')
BEGIN
...
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[Workers]') AND type = 'U')
BEGIN
...
-- =============================================
-- WorkersService (join gerada pelo EF HasMany/WithMany)
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
...
-- =============================================
-- WorkerServices (entidade join explícita)
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[WorkerServices]') AND type = 'U')
BEGIN
    CREATE TABLE [dbo].[WorkerServices] (
        [WSWorkerId]  INT NOT NULL,
        [WSServiceId] INT NOT NULL,

        CONSTRAINT [PK_WorkerServices]
...
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[Appointments]') AND type = 'U')
BEGIN
...
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[BusinessSchedules]') AND type = 'U')
BEGIN
...
-- =============================================
IF NOT EXISTS (SELECT * FROM sys.objects
    WHERE object_id = OBJECT_ID(N'[dbo].[WorkingHours]') AND type = 'U')
BEGIN
...
BEGIN
    ...
    VALUES
        ...
        (6, 1, '10:30', '16:00', NULL,     NULL      );  -- Saturday
END
GO
